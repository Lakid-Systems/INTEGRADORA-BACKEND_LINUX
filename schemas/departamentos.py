...
class DepartamentoUpdate(BaseModel):
    ...
    area_medica_id: Optional[UUID] = Field(None, example="f3e1b2d7-4b9d-4a3e-9f61-48e8b7d4a5e3", description="Nuevo ID de área médica")
    departamento_superior_id: Optional[UUID] = Field(None, example="c1a2b3c4-d5e6-7f89-0123-456789abcdef", description="Nuevo ID de departamento superior")
    responsable_id: Optional[UUID] = Field(None, example="123e4567-e89b-12d3-a456-426614174000", description="Nuevo responsable del departamento")
...
class Departamento(DepartamentoBase):
    ...
    id: UUID = Field(..., example="0c1d2e3f-4a5b-6789-0abc-def123456789", description="Identificador único del departamento")
